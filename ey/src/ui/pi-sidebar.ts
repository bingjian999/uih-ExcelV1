...
export class PiSidebar extends LitElement {
      ...
      <div class="pi-session-tabs">
        <div class="pi-session-tabs__scroller-wrap">
          ...
          <div class="pi-session-tabs__scroller" @scroll=${() => this._updateSessionTabOverflow()}>
            ...
            <button class="pi-session-tabs__new" @click=${() => this.onCreateTab?.()} aria-label="新建标签页">+</button>
          </div>
          <button
  ...
  private _renderUtilitiesMenu() {
    return html`
      <div class="pi-utilities-menu" id=${this._utilitiesMenuId} role="menu" aria-label="设置和工具">
        ...
        <div class="pi-context-pill">
          ...
          ${expanded ? html`
            <div class="pi-context-pill__body" id=${this._contextPillBodyId}>
              ...
              <div class="pi-context-pill__section">
                <span class="pi-context-pill__section-label">最近调用</span>
                <markdown-block .content=${recentMd}></markdown-block>
              </div>
              <div class="pi-context-pill__section">
                <div class="pi-context-pill__section-header">
                  <span class="pi-context-pill__section-label">工具</span>
                  ${ctx?.tools ? html`<button class="pi-context-pill__copy" @click=${this._copyToolsJson}>复制 JSON</button>` : nothing}
                </div>
                <markdown-block .content=${toolsTableMd}></markdown-block>
              </div>
              <div class="pi-context-pill__section">
                <span class="pi-context-pill__section-label">系统提示词</span>
    ...
    return html`
      <div class="pi-empty">
        <div class="pi-empty__content">
          <div class="pi-empty__logo">EY</div>
          <p class="pi-empty__tagline">
            理解并操作 Excel。记住你的偏好。自主构建工具。
          </p>
